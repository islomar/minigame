...
public class GameLevelServiceTest {
  ...
  public void given_more_than_15_users_post_scores_then_getHighScoreListForLevel_returns_only_15_top_scores() {
    ...
    //GIVEN
    Map<Integer, Score> expectedUserScoreMap = givenMoreThan15UsersWhoPostScores(levelId);
  ...
  private Map<Integer, Score> givenMoreThan15UsersWhoPostScores(Integer levelId) {
    Integer anotherLevelId = 456;
    Integer scoreValue = 300;
    Map<Integer, Score> expectedUserScoreMap = new LinkedHashMap<>();
    //TODO: hacer tests con sesión inválida, ver que no funciona
    ...
    expectedUserScoreMap.put(3, new Score(888, FIXED_INSTANT));
    expectedUserScoreMap.put(7, new Score(888, FIXED_INSTANT));
    expectedUserScoreMap.put(13, new Score(888, FIXED_INSTANT));
    expectedUserScoreMap.put(14, new Score(888, FIXED_INSTANT));
    expectedUserScoreMap.put(15, new Score(888, FIXED_INSTANT));
    expectedUserScoreMap.put(16, new Score(888, FIXED_INSTANT));
    expectedUserScoreMap.put(10, new Score(310, FIXED_INSTANT));
    expectedUserScoreMap.put(1, new Score(300, FIXED_INSTANT));
    expectedUserScoreMap.put(4, new Score(300, FIXED_INSTANT));
    expectedUserScoreMap.put(5, new Score(120, FIXED_INSTANT));
    expectedUserScoreMap.put(2, new Score(100, FIXED_INSTANT));
    expectedUserScoreMap.put(6, new Score(99, FIXED_INSTANT));
    expectedUserScoreMap.put(8, new Score(77, FIXED_INSTANT));
    expectedUserScoreMap.put(11, new Score(66, FIXED_INSTANT));
    expectedUserScoreMap.put(12, new Score(25, FIXED_INSTANT));
